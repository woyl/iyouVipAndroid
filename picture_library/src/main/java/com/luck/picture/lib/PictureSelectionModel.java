...
public class PictureSelectionModel {
     ...
     * @param medias
     */
    public void openExternalPreviewBack(int position, List<LocalMedia> medias,ResponListener<Boolean> responListener) {
        if (selector != null) {
            selector.externalPicturePreviewBack(position, medias,
                    selectionConfig.windowAnimationStyle != null &&
                            selectionConfig.windowAnimationStyle.activityPreviewEnterAnimation != 0
                            ? selectionConfig.windowAnimationStyle.activityPreviewEnterAnimation : 0,responListener);
        } else {
            throw new NullPointerException("This PictureSelector is Null");
        }
    }
