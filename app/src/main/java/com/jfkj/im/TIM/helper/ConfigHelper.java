...
import com.jfkj.im.TIM.component.face.CustomFace;
import com.jfkj.im.TIM.component.face.CustomFaceGroup;
...
public class ConfigHelper {
    ...
    public TUIKitConfigs getConfigs() {
        ...
        config.setAppCacheDir(App.getAppContext().getFilesDir().getPath());
