package com.jfkj.im.TIM.component;
...
import com.jfkj.im.TIM.base.ITitleBarLayout;
...
public class TitleBarLayout extends LinearLayout implements ITitleBarLayout {
    ...
    private ImageView mDonotDisturb;
...
//        setBackgroundColor(getResources().getColor(R.color.c1E1E1E));
    ...
    public void setMiddleIcon(int resId) {
        mDonotDisturb.setImageResource(resId);
    }
