...
import com.jfkj.im.TIM.component.PopupList;
...
public class MessageLayout extends MessageLayoutUI {
    ...
    public static final int DATA_CHANGE_TYPE_LOAD = 1;   //数据更改类型加载
    ...
    public static final int DATA_CHANGE_TYPE_GIF = 7;
    ...
    public void postSetAdapter(MessageListAdapter adapter) {
        mAdapter.setOnItemClickListener(new MessageLayout.OnItemClickListener() {
            ...
            public void onUserLongClick(View view, int position, MessageInfo messageInfo) {
                if(mOnItemClickListener != null){
                    mOnItemClickListener.onUserLongClick(view,position,messageInfo);
                }
            }
        });
    ...
    public interface OnItemClickListener {
        ...
        void onUserLongClick(View view, int position, MessageInfo messageInfo);
    }
