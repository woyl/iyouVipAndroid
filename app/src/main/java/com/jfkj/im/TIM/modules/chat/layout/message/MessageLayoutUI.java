...
import com.jfkj.im.TIM.modules.chat.interfaces.IMessageLayout;
import com.jfkj.im.TIM.modules.chat.interfaces.IMessageProperties;
...
import com.jfkj.im.manager.MylayoutManager;
...
public abstract class MessageLayoutUI extends RecyclerView implements IMessageLayout {
    ...
    private void init() {
        ...
        MylayoutManager linearLayoutManager = new MylayoutManager(getContext());
    ...
    @Override
    public void setOnCustomMessageDrawListener(IOnCustomMessageDrawListener listener,boolean isUpdate) {
        mAdapter.setOnCustomMessageDrawListener(listener,isUpdate);
    }
