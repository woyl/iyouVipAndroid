...
//        return "\"<font color=\"#5B6B92\">" + original + "</font>\"";
        return "\"<font color=\"#7F7F7F\">" + original + "</font>\"";
    }

    public static String covert3HTMLString(String original) {
//        return "\"<font color=\"#5B6B92\">" + original + "</font>\"";
        return "<font color=\"#FF2B66\">" + original + "</font>";
    }
