...
//        ivSwitch.setVisibility(mIsSwitch ? VISIBLE : GONE);
    }
    ...
    public void setPicContent(String content) {
        this.mContent = content;
        Drawable drawable = getResources().getDrawable(R.mipmap.icon_diamond_yellow);
        drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
        mContentText.setCompoundDrawables(drawable, null, null, null);
        mContentText.setText(content);
        mContentText.setTextColor(getResources().getColor(R.color.color_FF4D6C));
    }
