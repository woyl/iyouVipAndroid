...
public class MessageInfo {
    ...
    public static final int MSG_TYPE_Commemt=10001;

    public static final int MSG_TYPE_Praise=10001;
     ...
     * 广场 实力榜和魅力榜 提示消息
     */
    public static final int MSG_TYPE_SQUARE_TOP = 0x108;

    /**
     * 广场拆开红包提醒
     */
    public static final int MSG_TYPE_RED_ENVELOPE = 0x109;

    /**
     * 俱乐部发红包广场提示
     */
    public static final int MSG_CLUB_RED_ENVELOPES = 0x110;

    /**
     * 广场魅力榜 榜首提示
     */
    public static final  int MSG_PIAZZA_CHARM_LIST=0x111;


    /**
     * 广场实力榜 榜首提示
     */
    public static final  int MSG_PIAZZA_STRENGTH_LIST=0x111;
    ...
    public static final int MSG_STATUS_receive= 7;
    ...
    private  static  boolean headiv=true;
