...
public class GridImageOriginalAdapter extends RecyclerView.Adapter<GridImageOriginalAdapter.ViewHolder>{
    ...
    public GridImageOriginalAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
...
//        TextView tvDuration;
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = view.findViewById(R.id.iv_choose_picture);
...
//            tvDuration = view.findViewById(R.id.tv_duration);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_grid_picture,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                mOnAddPicClickListener.getListSize(list.size());
            });
