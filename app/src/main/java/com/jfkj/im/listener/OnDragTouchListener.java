...
//    private int mScreenWidth, mScreenHeight;//屏幕宽高
    ...
    public OnDragTouchListener(boolean isAutoPullToBorder, WindowManager windowManager,WindowManager.LayoutParams wmParams) {
...
//                mScreenHeight = v.getResources().getDisplayMetrics().heightPixels;
            ...
            case MotionEvent.ACTION_MOVE:
                Log.e("msg","...........event.getRawX()............."+event.getRawX());
                Log.e("msg","...........event.getRawY()............."+event.getRawY());
                Log.e("msg","...........event.getX()............."+event.getX());
                Log.e("msg","............event.getY()............"+event.getY());
                Log.e("msg","...........v.getLeft()............."+v.getLeft());
                Log.e("msg","............v.getTop()............"+v.getTop());
                Log.e("msg","...........v.getRight()............."+v.getRight());
                Log.e("msg","............v.getBottom()............"+v.getBottom());
                ...
                if (right > ScreenUtil.getScreenWidth()) {
                    right = ScreenUtil.getScreenWidth();
                    left = right - v.getWidth();
                }
                if (bottom > ScreenUtil.getScreenHeight()) {
                    bottom = ScreenUtil.getScreenHeight();
...
//                startAutoPull(v, lp);
    ...
    private void startAutoPull(final View v, final ViewGroup.MarginLayoutParams lp) {
        if (!hasAutoPullToBorder) {
            ...
            if (mListener != null) {
                mListener.onDragged(v, left, top,lp);
            }
            return;
        }
        //当用户拖拽完后，让控件根据远近距离回到最近的边缘
        float end = 0;
        if ((left + v.getWidth() / 2) >= ScreenUtil.getScreenWidth() / 2) {
            end = ScreenUtil.getScreenWidth() - v.getWidth();
        }
...
//            v.setLayoutParams(lp);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (mListener != null) {
                    mListener.onDragged(v, (int) finalEnd, top,lp);
                }
            }
        });
    ...
    public interface OnDraggableClickListener {
         ...
         * @param top  控件右边距
         */
        void onDragged(View v, int left, int top,ViewGroup.LayoutParams params);
