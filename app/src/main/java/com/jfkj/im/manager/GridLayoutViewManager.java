...
public class GridLayoutViewManager extends LinearLayoutManager {
     ...
     */
    public GridLayoutViewManager(Context context, AttributeSet attrs, int defStyleAttr,
                             int defStyleRes) {
     ...
     */
    public GridLayoutViewManager(Context context, int spanCount) {
        super(context);
...
//        }
        ...
        setOnLayoutChildre(recycler,state);
        clearPreLayoutSpanMappingCache();
    }

    private void setOnLayoutChildre(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int firstLineSize = 2 / 2 + 1;
        int secondLineSize = firstLineSize + 1 / 2;
...
//    }
     ...
     *
     * @seee GridLayoutManager#setSpanSizeLookup(SpanSizeLookup)
     */
