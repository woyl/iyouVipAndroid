 ...
 */
package com.jfkj.im.view.floatview.anchor;
...
public class CollapsedMenuAnchor {
    ...
    public Rect anchor(@NonNull Rect bounds) {
        Log.e(TAG, "Creating a new anchor position on the " + (LEFT == mSide ? "LEFT" : "RIGHT") + " side at a normalized vertical position: " + mNormalizedY);
        Log.e(TAG, "Anchoring bounds with height: " + bounds.height());
