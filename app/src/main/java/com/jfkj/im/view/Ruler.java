...
public class Ruler extends View {
    ...
    public Ruler(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currentValue=array.getInt(R.styleable.Ruler_currentValue, (int) ((fromValue+toValue)/2));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(orientation==VERTICAL){
            //画中间的指针,就在中间画，很简单
            paint.setColor(getResources().getColor(R.color.cEF4769));
            ...
            while(true){
                ...
                if(position%(intervalsBetweenValues/2)==0){
                    ...
                    if(position%intervalsBetweenValues==0){
                        ...
                        String valueString=Long.toString(position/intervalsBetweenValues*valuesInterval);
