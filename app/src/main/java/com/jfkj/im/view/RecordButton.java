...
import com.jfkj.im.utils.LogUtil;
...
public class RecordButton extends AppCompatButton {
    ...
    public RecordButton(Context context, AttributeSet attrs) {
     ...
     private String mFile =  getContext().getFilesDir()+ "/"+"tata_send_voice_"+ System.currentTimeMillis()+".mp3";
 //   private String mFile =getContext().getFilesDir()+ "/"+"tata_send_voice_"+ new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+".mp3";
