package com.jfkj.im.view.floatview.widget;
...
import com.jfkj.im.view.floatview.anchor.CollapsedMenuAnchor;
import com.jfkj.im.view.floatview.anchor.Dragger;
import com.jfkj.im.view.floatview.anchor.MagnetPositioner;
import com.jfkj.im.view.floatview.anchor.Navigator;
import com.jfkj.im.view.floatview.anchor.Positionable;
import com.jfkj.im.view.floatview.view.FloatView;
import com.jfkj.im.view.floatview.view.HoverMenuExitRequestListener;
    ...
    private Dragger.DragListener mDragListener = new Dragger.DragListener() {
        ...
        public void onDragTo(float x, float y) {
            getCollapsedMenuViewController().onDragTo(new Point(
                    (int) x + (getActiveTab().getWidth()),
                    (int) y + (getActiveTab().getHeight()))
            );
        }
...
//        mFloatViewSize = getResources().getDimensionPixelSize(R.dimen.floating_icon_size);
    ...
    private ObjectAnimator createEnterObjectAnimator() {
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder scaleX = PropertyValuesHolder.ofFloat("scaleX", 0.0f, 1.0f);
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder scaleY = PropertyValuesHolder.ofFloat("scaleY", 0.0f, 1.0f);
    ...
    private ObjectAnimator createExitObjectAnimator() {
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder scaleX = PropertyValuesHolder.ofFloat("scaleX", 1.0f, 0.1f);
        @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder scaleY = PropertyValuesHolder.ofFloat("scaleY", 1.0f, 0.1f);
...
//            ));
            getCollapsedMenuViewController().onDragTo(new Point(
                    60 + (floatView.getWidth() / 4),
                    (int) (bottom - floatView.getHeight() * 1.8)
            ));
        } else {
