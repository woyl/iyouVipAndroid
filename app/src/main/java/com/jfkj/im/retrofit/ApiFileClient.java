...
public class ApiFileClient {
    private static Retrofit mRetrofit = null;
    private static ApiFileClient apiClient = null;

    public ApiFileClient() {
    }

    public  static ApiFileClient getInstance() {
        if (apiClient == null) {
            apiClient = new ApiFileClient();
        }
        return apiClient;
    }
