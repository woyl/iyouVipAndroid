...
public class SoftKeyBoardListener {
    ...
    private SoftKeyBoardListener(Activity activity,Button  button) {
        int state = WindowManager.LayoutParams.SOFT_INPUT_MASK_STATE & activity.getWindow().getAttributes().softInputMode;
        switch (state) {
            case WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE:
            case WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE:
        ...
        rootView.getViewTreeObserver().addOnGlobalLayoutListener(listener);
        button.getViewTreeObserver().addOnGlobalLayoutListener(listener);
        addLifeObServer(activity);
    }
    ...
    public static void setListener(Activity activity, OnSoftKeyBoardChangeListener onSoftKeyBoardChangeListener,Button  button) {

        SoftKeyBoardListener softKeyBoardListener = new SoftKeyBoardListener(activity,button);
