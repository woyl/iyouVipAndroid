package com.jfkj.im.utils.datepicker;
...
//            mDpvHour, mDpvMinute
    ...
    private boolean bBoolean1 = false;
...
//        void onTimeSelected(long startTime, long endTime, String start, String end, Vector<Boolean> vector);
    }
     ...
     */
    public CustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr, Long startTime1, Long endTime1) {
        this(context, callback, DateFormatUtils.str2Long(beginDateStr, false),
                DateFormatUtils.str2Long(endDateStr, false), startTime1, endTime1);
    }
     ...
     */
    public CustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp, long startTime11, long endTime11) {
...
//        endTime1 = endTime11;
    ...
    private void initView() {
        ...
        if (window != null) {
            ...
            int size = ScreenUtil.getScreenWidth();
            lp.width = (int) (size*0.8);
