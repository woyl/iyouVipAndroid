...
public class DateFormatUtils {
    ...
    private static final String DATE_FORMAT_PATTERN_YMD_HM = "HH:mm";
    private static final String DATE_FORMAT_PATTERN_YMD_HM_ALL = "yyy-MM-dd HH:mm";
    ...
    public static String long2Str2(long timestamp, boolean isPreciseTime) {
        return long2Str(timestamp, DATE_FORMAT_PATTERN_YMD_HM_ALL);
    }
