package com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn;
...
import static com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn.CdnPlayerConfig.CACHE_STRATEGY_AUTO;
import static com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn.CdnPlayerConfig.CACHE_STRATEGY_FAST;
import static com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn.CdnPlayerConfig.CACHE_STRATEGY_SMOOTH;
import static com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn.CdnPlayerConfig.CACHE_TIME_FAST;
import static com.jfkj.im.utils.trtc.trtc.sdkadapter.cdn.CdnPlayerConfig.CACHE_TIME_SMOOTH;
...
public class CdnPlayManager {
    ...
    public void initPlayUrl(int roomId, String userId) {
        ...
        // 拼接流id
        String streamId = "3891_" + VideoUtils.md5("" + roomId + "_" + userId + "_main");
        // 拼接旁路流地址
