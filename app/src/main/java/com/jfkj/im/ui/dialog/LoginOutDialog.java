...
public class LoginOutDialog extends Dialog implements View.OnClickListener {
    ...
    public LoginOutDialog(Context context, int theme, CommonDialog.CustomizeDialogListener listener) {
        super(context, theme);
        this.context = context;
        this.listener = listener;
        mView = LayoutInflater.from(context).inflate(R.layout.dialog_login_out, null);
    }

    public LoginOutDialog(Context context, CommonDialog.CustomizeDialogListener listener) {
    ...
    public LoginOutDialog setContentText(String content) {
