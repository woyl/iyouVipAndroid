...
import com.jfkj.im.mvp.Home.ReportPresenter;
import com.jfkj.im.mvp.Home.ReportView;
 ...
 * </pre>
 */
public class ReportActivity extends BaseActivity<ReportPresenter> implements ReportView, GridImageOriginalAdapter.onAddPicClickListener {
    ...
    CheckBox mInfo3;
    @BindView(R.id.info_4)
    CheckBox mInfo4;
    @BindView(R.id.info_5)
    CheckBox mInfo5;
    @BindView(R.id.info_6)
    CheckBox mInfo6;
...
//        mAdapter.setList(selectList);
            ...
            if (selectList.size() > 0) {
                ...
                switch (mediaType) {
                    case PictureConfig.TYPE_VIDEO:
                        // 预览视频
                        PictureSelector.create(ReportActivity.this).externalPictureVideo(media.getPath());
                        break;
                    case PictureConfig.TYPE_AUDIO:
                        // 预览音频
                        PictureSelector.create(ReportActivity.this).externalPictureAudio(media.getPath());
                        break;
                    default:
                        // 预览图片 可自定长按保存路径
    ...
    private void setTvListener() {
        ...
        if(types.size()  == 0  || selectList.size() ==0){
...
//        }
    ...
    @OnClick({R.id.iv_title_back, R.id.info_1, R.id.info_2, R.id.info_3, R.id.info_4, R.id.info_5, R.id.info_6, R.id.tv_confirm})
