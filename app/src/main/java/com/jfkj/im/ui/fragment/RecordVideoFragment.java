...
import com.jfkj.im.utils.media.CameraHelper;
...
//        }
     ...
     //   mOutputVideoFile = CameraHelper.getOutputMediaFile(CameraHelper.MEDIA_TYPE_VIDEO);
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            mOutputVideoFile = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), System.currentTimeMillis() + ".mp4");
        } else {
            mOutputVideoFile = new File(getActivity().getFilesDir(), System.currentTimeMillis() + ".mp4");
        }
