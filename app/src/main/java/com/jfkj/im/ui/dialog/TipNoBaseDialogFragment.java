...
public class TipNoBaseDialogFragment extends BaseDialogFragment implements View.OnClickListener{
    ...
    public TipNoBaseDialogFragment(boolean isWidth, int ori,String content,String cancel,String sure,boolean isCenter) {
        super(isWidth, ori);
    ...
    protected void initViews() {
        view = inflater.inflate(R.layout.dialog_tip_no_base_dialog_f,null);
