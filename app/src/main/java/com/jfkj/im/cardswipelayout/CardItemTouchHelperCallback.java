package com.jfkj.im.cardswipelayout;
...
public class CardItemTouchHelperCallback<T> extends ItemTouchHelper.Callback {
    ...
    private ResponListener<Integer> responListener;
    private int num;

    public void setResponListener(ResponListener<Integer> responListener){
