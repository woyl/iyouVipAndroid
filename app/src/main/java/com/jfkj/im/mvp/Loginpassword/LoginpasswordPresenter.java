...
public class LoginpasswordPresenter extends BasePresenter<LoginpasswordView> {
    ...
    public void login(String mobileno, String password,String longitude, String latitude, String locality) {
        ...
        map.put(Utils.DEVICEID,"jiguang_" + UserInfoManger.getRegistrationID());

        OkHttpUtils.post()
                .tag(App.getAppContext())
                .url(ApiStores.base_url+"/user/phoneLogin")
