package com.jfkj.im.mvp.selectpackets;
...
public class Selectpacketspresenter  extends BasePresenter<SelectpacketsView> {

    public Selectpacketspresenter(SelectpacketsView selectpacketsView) {
