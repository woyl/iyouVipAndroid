package com.jfkj.im.payments.weixin;
...
public class WXPay {
     ...
     * @param wx_appid
     * */
    private WXPay(Context context, String wx_appid) {
    ...
    public static WXPay getInstance(Context context, String wx_appid){
        if(null==mWXPay) mWXPay=new WXPay(context,wx_appid);
        return mWXPay;
    }
